...
// */
//final class Version20190724091636 extends AbstractMigration
//{
...
//
//        $this->addSql('ALTER TABLE content ADD author_id INT NOT NULL, DROP author');
...
//        $this->addSql('ALTER TABLE content ADD author VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP author_id');
//    }
//}
